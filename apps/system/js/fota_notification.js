...
var JrdFotaNotifiCation = {
  ...
  init: function fn_init() {
    ...
    // tcl_longxiuping add for PR 625956 begin
    this.DeskNotifContainer =
      document.getElementById('desktop-notifications-container');
    this.updateManagerContainer =
      document.getElementById('update-manager-container');
    // tcl_longxiuping add for PR 625956 end
   ...
   addNotification: function fn_addNotification(param) {
     ...
     // tcl_longxiuping modified for PR 625956
   ...
   removeNotification: function fn_removeNotification() {
     ...
     // tcl_longxiuping add for PR 625956 begin
     if (!this.DeskNotifContainer.firstElementChild &&
       !this.notifContainer.firstElementChild &&
       !this.updateManagerContainer.classList.contains('displayed')) {
